...
namespace MyTool 
{
	...
	public:
		...
		//StartingForm(const StartingForm %form):
		//	this(%form)
		//{	
	...
	public: TextureTableForm^ form2_table;
	public: TextureLoadForm^ form3_loading;
	...
	#pragma region Windows Form Designer generated code
		...
		{	
			...
			this->textbox_ProjectPath->DoubleClick += gcnew System::EventHandler(this, &StartingForm::textbox_ProjectPath_DoubleClick);
			this->textbox_ProjectPath->Leave += gcnew System::EventHandler(this, &StartingForm::textbox_ProjectPath_Leave);
			// 
			...
			this->textBox_GamefieldPath->Click += gcnew System::EventHandler(this, &StartingForm::textBox_GamefieldPath_Click);
			this->textBox_GamefieldPath->DoubleClick += gcnew System::EventHandler(this, &StartingForm::textBox_GamefieldPath_DoubleClick);
			this->textBox_GamefieldPath->Leave += gcnew System::EventHandler(this, &StartingForm::textBox_GamefieldPath_Leave);
			// 
			...
			this->textBox_repairsFolder->DoubleClick += gcnew System::EventHandler(this, &StartingForm::textBox_repairsFolder_DoubleClick);
			this->textBox_repairsFolder->Leave += gcnew System::EventHandler(this, &StartingForm::textBox_repairsFolder_Leave);
			// 
			// openFileDialog1
			// 
			...
			this->listBox_Chapters->SelectedIndexChanged += gcnew System::EventHandler(this, &StartingForm::listBox_Chapters_SelectedIndexChanged);
			// 
			...
			this->button_search->Click += gcnew System::EventHandler(this, &StartingForm::button_search_Click);
			// 
			// button_find_next
			// 
			...
			this->button_find_next->Click += gcnew System::EventHandler(this, &StartingForm::button_next_search_Click);
			// 
			// button_find_prev
			// 
			...
			this->button_find_prev->Click += gcnew System::EventHandler(this, &StartingForm::button_find_prev_Click);
			// 
			...
			this->button_minus_chapter->Click += gcnew System::EventHandler(this, &StartingForm::button_minus_chapter_Click);
			// 
			// button_plus_chapter
			// 
			...
			this->button_plus_chapter->Click += gcnew System::EventHandler(this, &StartingForm::button_plus_chapter_Click);
			// 
			...
			this->button_clear_list_chapter->Click += gcnew System::EventHandler(this, &StartingForm::button_clear_list_chapter_Click);
			// 
			// textBox_LOGFILE
			// 
			...
			this->textBox_LOGFILE->Leave += gcnew System::EventHandler(this, &StartingForm::textBox_LOGFILE_Leave);
			// 
			// label_LOGFILE
			// 
			...
			this->button_define_unused_textures->Click += gcnew System::EventHandler(this, &StartingForm::button_define_unused_textures_Click);
			// 
			...
			this->textBox_textures_folder->DoubleClick += gcnew System::EventHandler(this, &StartingForm::textBox_textures_folder_DoubleClick);
			this->textBox_textures_folder->Leave += gcnew System::EventHandler(this, &StartingForm::textBox_textures_folder_Leave);
			// 
			...
			this->listBox_ObLib->SelectedIndexChanged += gcnew System::EventHandler(this, &StartingForm::listBox_ObLib_SelectedIndexChanged);
			// 
			...
			this->button_minus_cluster->Click += gcnew System::EventHandler(this, &StartingForm::button_minus_cluster_Click);
			// 
			// button_plus_cluster
			// 
			...
			this->button_plus_cluster->Click += gcnew System::EventHandler(this, &StartingForm::button_plus_cluster_Click);
			// 
			...
			this->button_tab2_clear_ch->Click += gcnew System::EventHandler(this, &StartingForm::button_tab2_clear_ch_Click);
			// 
			...
			this->button_tab2_minus_ch->Click += gcnew System::EventHandler(this, &StartingForm::button_tab2_minus_ch_Click);
			// 
			// button_tab2_plus_ch
			// 
			...
			this->button_tab2_plus_ch->Click += gcnew System::EventHandler(this, &StartingForm::button_tab2_plus_ch_Click);
			// 
			...
			this->button_effects_table->Click += gcnew System::EventHandler(this, &StartingForm::button1_Click);
			// 
			...
			this->button_chapter_editor->Click += gcnew System::EventHandler(this, &StartingForm::button_chapter_editor_Click);
			// 
			// Tabs
			// 
			...
			this->Tabs->SelectedIndexChanged += gcnew System::EventHandler(this, &StartingForm::Tabs_SelectedIndexChanged);
			// 
			// tabPage2
			// 
			...
			this->button_chooseChapter->Click += gcnew System::EventHandler(this, &StartingForm::button_chooseChapter_Click);
			// 
			// tableLayoutPanel3
			// 
			...
			this->listBox_CH->SelectedIndexChanged += gcnew System::EventHandler(this, &StartingForm::listBox_CH_SelectedIndexChanged);
			// 
			// tableLayoutPanel7
			// 
			...
			this->button_tab2_choose_ch->Click += gcnew System::EventHandler(this, &StartingForm::button_tab2_choose_ch_Click);
			// 
			...
			this->button_change_attribute->Click += gcnew System::EventHandler(this, &StartingForm::button_change_attribute_Click);
			// 
			// tableLayoutPanel8
			// 
			...
			this->comboBox_attribute->SelectedIndexChanged += gcnew System::EventHandler(this, &StartingForm::comboBox_attribute_SelectedIndexChanged_1);
			// 
			// comboBox_znak
			// 
			...
			this->comboBox_znak->SelectedIndexChanged += gcnew System::EventHandler(this, &StartingForm::comboBox_znak_SelectedIndexChanged_1);
			// 
			// textBox_value
			// 
			...
			this->textBox_value->Click += gcnew System::EventHandler(this, &StartingForm::textBox_value_Click);
			this->textBox_value->Leave += gcnew System::EventHandler(this, &StartingForm::textBox_value_Leave_1);
			// 
			// tableLayoutPanel11
			// 
			...
			this->checkBox_all->CheckedChanged += gcnew System::EventHandler(this, &StartingForm::checkBox_all_CheckedChanged);
			// 
			// checkbox_hash_id
			// 
			...
			this->checkbox_hash_id->CheckedChanged += gcnew System::EventHandler(this, &StartingForm::checkbox_hash_id_CheckedChanged);
			// 
			// tableLayoutPanel9
			// 
			...
			this->comboBox_repair->SelectedIndexChanged += gcnew System::EventHandler(this, &StartingForm::comboBox_repair_SelectedIndexChanged);
			// 
			// label_repair
			// 
			...
			this->comboBox_step->SelectedIndexChanged += gcnew System::EventHandler(this, &StartingForm::comboBox_step_SelectedIndexChanged);
			// 
			// label3
			// 
			...
			this->textBox_ids->Click += gcnew System::EventHandler(this, &StartingForm::textBox_ids_Click);
			this->textBox_ids->Leave += gcnew System::EventHandler(this, &StartingForm::textBox_ids_Leave_1);
			// 
			// textBox_search
			// 
			...
			this->textBox_search->Click += gcnew System::EventHandler(this, &StartingForm::textBox_search_Click);
			this->textBox_search->Leave += gcnew System::EventHandler(this, &StartingForm::textbox_ProjectPath_Leave);
			// 
			// tableLayoutPanel5
			// 
			...
			this->Text = L"MyTool";
			this->FormClosed += gcnew System::Windows::Forms::FormClosedEventHandler(this, &StartingForm::StartingForm_FormClosed);
			this->Load += gcnew System::EventHandler(this, &StartingForm::StartingForm_Load);
			this->Shown += gcnew System::EventHandler(this, &StartingForm::StartingForm_Shown);
...
private: System::Void StartingForm_Shown(System::Object^  sender, System::EventArgs^  e)
{
	std::string path = msclr::interop::marshal_as<std::string>(textbox_ProjectPath->Text);
...
private: System::Void StartingForm_FormClosed(System::Object^  sender, System::Windows::Forms::FormClosedEventArgs^  e)
{
	Application::Exit();
}
...
{	
	...
	if (textures.empty())
	{
		form3_loading = gcnew TextureLoadForm("texture_table");

		form3_loading->Load += gcnew System::EventHandler(this, &MyTool::StartingForm::OnLoadForm3);
		form3_loading->ClosingForm3 += gcnew System::EventHandler(this, &MyTool::StartingForm::OnClosingForm3);
...
void MyTool::StartingForm::OnLoadForm3(System::Object ^sender, System::EventArgs ^e)
	{
		this->Hide();
	}

void MyTool::StartingForm::OnClosingForm3(System::Object ^sender, System::EventArgs ^e)
{
	this->Show();
}
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) 
{
	...
	else
	{
		...
		form3_loading = gcnew TextureLoadForm("effect_table");
