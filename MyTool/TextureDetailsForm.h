...
#ifndef TEXTURE_DETAILS_FORM_H
#define TEXTURE_DETAILS_FORM_H
...
namespace MyTool {
	...
	/// <summary>
	/// Summary for TextureDetailsForm
	/// </summary>
	public ref class TextureDetailsForm : public System::Windows::Forms::Form
	{
	
	public:	Effect_detail^ eff_TextureDetailsForm;
	...
	public:
		...
		TextureDetailsForm(String^ texture_path)
		{	
		...
		TextureDetailsForm(TextureData* d)
		{
			this->texture = d;
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->DoubleClick += gcnew System::EventHandler(this, &TextureDetailsForm::pictureBox1_DoubleClick);
			// 
			// label_texture_name
			// 
			...
			this->advancedDataGridView_EF->CellContentDoubleClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &TextureDetailsForm::advancedDataGridView_EF_CellContentDoubleClick);
			// 
			...
			this->Name = L"TextureDetailsForm";
			this->Text = L"TextureDetailsForm";
			this->Load += gcnew System::EventHandler(this, &TextureDetailsForm::TextureDetailsForm_Load);
...
private: System::Void TextureDetailsForm_Load(System::Object^  sender, System::EventArgs^  e)
{	
	pictureBox1->Image = byteArrayToImage(GetImageForData(msclr::interop::marshal_as<String^>(texture->TD_texture_name.string())));
...
private: System::Void advancedDataGridView_EF_CellContentDoubleClick(System::Object^  sender, System::Windows::Forms::DataGridViewCellEventArgs^  e) 
{
	...
	this->eff_TextureDetailsForm = gcnew Effect_detail(effect_path);
	eff_TextureDetailsForm->Show();
}
